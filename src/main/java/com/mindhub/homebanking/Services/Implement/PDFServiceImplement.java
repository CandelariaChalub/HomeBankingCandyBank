...
public class PDFServiceImplement implements PDFService {
    ...
    public void generatePDF(HttpServletResponse response, List<Transaction> transactions, Account account) {
        try {
            ...
            Paragraph title = new Paragraph("CandyBank - account summary", titleFont);
            ...
            Paragraph date = new Paragraph("Date of issue: " + LocalDate.now(), subFont);
            ...
            Image img = Image.getInstance("./src/main/resources/static/public/assets/img/favicon.png");
            ...
            pdfPCell1.setBackgroundColor(new BaseColor(255, 4, 176));
            pdfPCell2.setBackgroundColor(new BaseColor(255, 4, 176));
            pdfPCell3.setBackgroundColor(new BaseColor(255, 4, 176));
            pdfPCell4.setBackgroundColor(new BaseColor(255, 4, 176));
